      ...
      <ul>
        ...
        <li>
          <article>
            ...
            <h3>Audience.</h3>
            <p>
              I'm a Full Stack developer specialized in building web applications with React and Redux. My intended audience are recruiters, inspired future developers, and anyone interested in exploring the world of web development.
            </p>
          </article>
        </li>
        <li>
          <article>
            ...
            <h3>Profit.</h3>
            <p>
              My goal is not gain profit but to CREATE and DESIGN programs that I enjoy building.
            </p>
          </article>
        </li>
      </ul>
